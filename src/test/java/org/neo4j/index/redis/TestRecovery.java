...
public class TestRecovery
{
    ...
    public void testRecovery() throws Exception
    {
        ...
        final Index<Node> nodeIndex = nodeIndex( graphDb, "node-index" );
        final Index<Relationship> relIndex = relIndex( graphDb, "rel-index" );
    ...
    public void testAsLittleAsPossibleRecoveryScenario() throws Exception
    {
        ...
        Index<Node> index = nodeIndex( db, "my-index" );
        db.beginTx();
